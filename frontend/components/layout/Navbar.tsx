...
export function Navbar() {
  ...
  return (
    <nav className="bg-bg-surface border-b border-border-dim sticky top-0 z-50">
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden border-t border-border-dim bg-bg-surface px-4 py-3 space-y-1">
          {links.map((link) => (
            <Link
              key={link.href}
              href={link.href}
